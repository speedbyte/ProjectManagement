...
\begin{document}
	...
	\chapter{Einrichtung}
		...
		\section{Datenbank}
			\begin{enumerate}
				...
				\item 
					...
					\end{verbatim}
				\item
					Nun k"onnen wir eine Tabelle anlegen:
					\begin{verbatim}
		...
		\section{Python}
			\begin{enumerate}
				\item[] 
					Um sp"ater Daten empfangen zu k"onne und diese in der Datenbank abzulegen ben"otigen wir Python. Da es sich um eine Skriptsprache handelt, ist eine IDE nicht vonn"oten. 
				\item
	...
	\chapter{Anwendung}
		...
		\section{Python}
			...
			\subsection{Ablegen der Daten}
				...
				\end{figure}\\	
				Um sicherzustellen, dass das Skript funktioniert kann mit dem \textit{udpSend} Skipt ein Senden des Quadrocopters simuliert werden. Jedoch handelt es sich hierbei nur um Zufallswerte. 
			...
			\subsection{Adminer bedienen}
				\begin{enumerate}
					...
					\item
						...
						\end{figure}
					\item 
						Die Importfunktion erm"oglicht es Ihnen einen Dump der Datenbank zu Imporieren. W"ahlen sie dazu einfach eine \textit{sql} Datei aus und klicken auf ausführen.
				\end{enumerate}
	\newpage
