...
Interessant ist auch~\cite{bib:Quelle2} und \cite{bib:Quelle1} -- so sieht's aus. Langsam wird es spät\ldots ich  gehe ins Bett. 

Zitieren will gelernt sein -- die TU~Berlin \cite{bib:www:TUBerlin} gibt folgende Ratschläge:
