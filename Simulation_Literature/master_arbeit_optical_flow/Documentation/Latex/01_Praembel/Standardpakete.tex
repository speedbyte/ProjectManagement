...
% alternativ - ähnlich der LaTeX-StabdardschrifrStandardschrift Computer Modern (unterstützt Zeichen mit Akzenten etc. besser)
%\usepackage{lmodern}
...
% Im Textmodus wird die Formatierung des restlichen Text übernommen (fett etc.)
\usepackage{units}
...
% bessere Unterstützung von Gleitumgebungen
\usepackage{float}
...
% Es stellt das Symbol der europäischen Währung, des Euro, in LaTeX zur Verfügung.
...
% Standardpfad für Grafiken definieren, siehe LaTeX-Begleiter auf Seite 642 ff.
