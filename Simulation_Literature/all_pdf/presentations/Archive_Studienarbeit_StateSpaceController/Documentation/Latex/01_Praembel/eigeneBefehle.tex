...
% Änderungen in Bezug auf Verweise
% --------------------------------
...
%Gradzeichen - benötigt die Pakete: textcomp, amsmath und units
...
% Anführungszeichen für wörtliche Zitate
\newcommand{\Zitat}[1]{
\glqq#1\grqq\xspace
}
...
% Formatierung für uneigentliche, umgangssprachliche oder selbstkonstruierte Begriffe (-> uusB)
% Denn: Die Verwendung von Anführungszeichen ist dem echten Zitat vorbehalten!
