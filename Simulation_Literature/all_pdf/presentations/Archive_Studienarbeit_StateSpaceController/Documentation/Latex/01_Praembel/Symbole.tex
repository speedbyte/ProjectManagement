...
% -------------------------------------------------------
% textcomp-Paket
% Das Ergänzungspaket textcomp stellt verschiedene Symbole für den Textmodus
% bereit (mathcomp analog für Mathematikmodus).
% Es baut auf den EC-Schriften auf (hier: cmr).
% Verwendet man andere Schriften, so stehen nicht alle Symbole zur Verfügung.

% Mit der Paket-Option force kann man erwzingen, dass Zeichen immer ausgegeben werden,
% auch wenn die Gefahr besteht, dass das Symbol in der Schriftart nicht verfügbar ist
% -> man bekommt dann evtl. ein gefülltes Viereck

% Oder besser:  [force,almostfull].  Im Gegensatz zu [force] alleine
% werden dann wenigstens diejenigen Zeichen automatisch durch CM
% ersetzt, die in nicht-CM-Fonts so gut wie immer fehlen, nämlich
% \t und \textcircled.
...
% -------------------------------------------------------
% marvosym-Paket - verträgt sich nicht mit dem textcomp-Paket: entweder oder

% Weitere Symbole

% Doku: 98_Sonstiges/marvodoc.pdf

% Paket überschreibt den Mathematik-Befehl "\Rightarrow" -> nachfolgend ein Workarround, um den ursprünglichen Befehl zu "retten".
